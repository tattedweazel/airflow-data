...
############## EDIT THIS PART ####################
s3_to_redshift_schema = 'dw.hades'
staging_schema = 'hades'
target_schema = 'hades'

events = [
    'sandbox_vod_sessions'
]

############## STOP EDITING HERE ##################

dag_name = 'sandbox_dag'
...
EVENTS = dag_builder.build_event_jobs(event_names=events, job_path='dags/sandbox_jobs')
SPARK_STEPS = []
