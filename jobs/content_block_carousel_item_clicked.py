...
event_name = 'content_block_carousel_item_clicked'
...
def get_platform_events(platform):
        ...
        return event_data_df.alias("ed")\
                ...
                .selectExpr("ed.id as message_id",
                        ...
                        "ed.carousel_item_index as carousel_item_index",
                        "ed.carousel_per_page as carousel_per_page",
                        "ed.carousel_item_page as carousel_item_page",
