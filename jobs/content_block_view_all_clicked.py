...
event_name = 'content_block_view_all_clicked'
...
def get_platform_events(platform):
    ...
    if 'link_to' not in event_data_df.columns:
        event_data_df = event_data_df.withColumn('link_to', F.lit(None).cast("string"))
    ...
    return event_data_df.alias("ed") \
        ...
        .selectExpr("ed.id as message_id",
                    ...
                    "substring(ed.link_to, 1, 512) as link_to",
