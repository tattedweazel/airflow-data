...
def get_platform_events(platform):
    ...
    if 'option_selected' not in event_data_df.columns:
        event_data_df = event_data_df.withColumn('option_selected', F.lit(None).cast("string"))
    ...
    if 'campaign' not in event_data_df.columns:
        event_data_df = event_data_df.withColumn('campaign', F.lit(None).cast("string"))

    if 'code_applied' not in event_data_df.columns:
        event_data_df = event_data_df.withColumn('code_applied', F.lit(None).cast("string"))
